...
| "9,649 project-month-employee observations (42 projects and 580 employees)" — the paper's own wording, in its conclusion. Re-checked because a web summary of the VOR gives **58** employees; the paper says 580, and the page is right. Corroborates the row above from a second deposit | as above | 10 Sep 2026 |
